...
global.printDialogueOverlay = (player, speaker) =>
{
    ...
    const speakertexture = `godsblessing:textures/gui/${speaker[0]}.png`
    ...
    player.paint({
        radioBG: {
            ...
            h: 48,
            color: '#FFFFFF',
            texture: 'godsblessing:textures/gui/dialogue_overlay.png',
            alignX: 'left',
            alignY: 'top',
            draw: 'ingame'
        }
    ...
    player.paint({
        radioDialogue: {
            ...
            h: 48,
            color: '#FFFFFF',
            texture: 'godsblessing:textures/gui/dialogue_overlay_dialoguebox.png',
            alignX: 'left',
            alignY: 'top',
            draw: 'ingame'
        },
...
global.BeginDialogue = (player, npc, text) =>
{
